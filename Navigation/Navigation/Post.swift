...
struct Posts {
    ...
    static func makePost() -> [[Posts]] {
        ...
        section.append(Posts(author: "Star Wars", image: UIImage(named: "Mandalorian")!, description: "Гриф Карга уговаривает Дина Джарина в первом отрывке из третьего сезона «Мандалорца»", likes: Int.random(in: 300...500), views: Int.random(in: 700...1999)))
